...
public class DungeonPBlendModes
{
	public static Texture2D Blend(Texture2D lowerLayer, float lowerOpacity, Texture2D upperLayer, float upperOpacity, DungeonPLayer.BlendMode mode)
	{
		switch (mode)
		{
			case DungeonPLayer.BlendMode.NORMAL:
				return Normal(lowerLayer, lowerOpacity, upperLayer, upperOpacity);
			case DungeonPLayer.BlendMode.MULTPILY:
				return Multiply(lowerLayer, lowerOpacity, upperLayer, upperOpacity);
			case DungeonPLayer.BlendMode.SCREEN:
